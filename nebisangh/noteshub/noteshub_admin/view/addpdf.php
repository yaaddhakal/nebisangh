...
if(isset($_POST['submit']))
{
  ...
  $tz = 'Asia/Kathmandu';
      ...
      // if($_FILES['pdfnote']['error']==0 && $_FILES['pdfnote']['size']!=0)  
     
     if($_FILES['pdfnote']['error']==0 && $_FILES['pdfnote']['size']!=0)  
    {
      $iname=$_FILES['pdfnote']['name'];
      move_uploaded_file($_FILES['pdfnote']['tmp_name'], 'view/pdfs/'.$iname);
        $this->pdf->pdflocation =$iname;
      $return = $this->pdf->insertpdf();   
      }
      else
      {
        $err[5]="Please put valid pdf only";
      }
...
<!--  	<div class="validation-system">
 ...
 -->
  	    <h1>ADD PDF</h1>
        <form method="post" enctype="multipart/form-data"  action="<?php echo base_url().'addpdf' ?>">
         	<div class="vali-form">
            <div class="col-md-6 form-group1">
              <label class="control-label"> Title</label>
              <input type="text" name="title" placeholder="Example First Title" required="">
            </div>
          ...
          <div class="col-md-6">
           ...
           <div class="clearfix"> </div>
            <div class="col-md-6 form-group1">
              ...
              <input type="text" name="subject" placeholder="Example First Title" required="">
            </div>
             <div class="clearfix"> </div>
              <div class="col-md-6 form-group1">
              <label class="control-label"> Provider</label>
              <input type="text" name="provider" placeholder="Example First Title" required="">
            </div>
             <div class="clearfix"> </div>

          Add PDF<input type="file" name="pdfnote" accept="application/pdf" >
