...
if(isset($_POST['submit']))
{
  ...
  $tz = 'Asia/Kathmandu';
      ...
      $return = $this->semester->updatesemester($this->selectsemesterbyid[0]->id);
      if($return)
      {
        echo "<script> alert('Updated Successfully')</script>";
         echo "<script> window.location='".base_url()."updatesemester/".$this->selectsemesterbyid[0]->id."'</script>";
      }
      else
      {
...
<!--  	<div class="validation-system">
 ...
 -->
        ...
        <form method="post" action="<?php echo base_url().'updatesemester/'.$this->selectsemesterbyid[0]->id ?>">
         	<div class="vali-form">
            <div class="col-md-6 form-group1">
              <label class="control-label">Semester Name</label>
              <input type="text" name="name" value="<?php echo $this->selectsemesterbyid[0]->sem_name ?>" placeholder="Example First Semester" required="">
            </div>
            ...
            <option value="<?php echo $this->selectsemesterbyid[0]->university_id ?>"><?php echo $this->uniname[0]->name ?></option>
                <?php
           ...
           <div class="col-md-6">
            ...
            <select class="form-control1" id='level' name="level"  style="background-color:#fff">
              <option value='<?php echo $this->selectsemesterbyid[0]->level_id ?>'><?php echo $this->levelname[0]->level_name ?></option>
           ...
           <div class="col-md-6">
            ...
            <option value='<?php echo $this->selectsemesterbyid[0]->faculty_id ?>'><?php echo $this->facultyname[0]->faculty_name ?></option>
            </select>
          </div>
