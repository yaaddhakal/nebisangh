       	...
       	<div class="row">
			<div class="col-md-12">
       		...
       		<tr>
       			...
       			<th data-field="uniname">University Name</th>
       			<th data-field="head"> Headquater City</th>
       		...
       		<?php
       		$n=0;
       		foreach ($this->showuni as $ad) {
       			$n++;
       			echo "<tr><td>$n</td>";
       			echo "<td>$ad->name</td>";
       			echo "<td>$ad->headquater_city</td>";
       			echo "<td>$ad->created_by</td>";
       			echo "<td> $ad->created_at </td>";
       			
       			if($_SESSION['role']=='SuperAdmin' || $_SESSION['admin']==$ad->created_by)
       			{
       				echo "<td><a href='".base_url()."updateuni/$ad->id' class='btn btn-primary'>Update</a><a href='".base_url()."deleteuni/$ad->id'' class='btn btn-danger'>Delete </a></td>";
       			}
       			else
       			{
