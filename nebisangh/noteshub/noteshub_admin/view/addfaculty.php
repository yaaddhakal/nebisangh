...
if(isset($_POST['submit']))
{
  ...
  $tz = 'Asia/Kathmandu';
      ...
      $return = $this->faculty->insertfaculty();
      if($return)
      {
...
<div id="page-wrapper" class="gray-bg dashbard-1">
 	...
 	<!---->
        ...
        <form method="post" action="<?php echo base_url().'addfaculty' ?>">
         	<div class="vali-form">
            <div class="col-md-6 form-group1">
              <label class="control-label">Faculty Name</label>
              <input type="text" name="name" placeholder="Example Computer Engineering" required="">
            </div>
         ...
         <div class="col-md-6">
           ...
           <!--  <div class="col-md-6 form-group1 form-last">
              ...
              <select  id="uni" style="height:35px;width:300px;margin-top:-1em;">
                <option>Choose University</option!-->
