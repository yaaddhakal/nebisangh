			...
			<div class="col-md-12">
       		...
       		<tr>
       			...
       			<th data-field="sn">S.N</th>
                            <th data-field="Semester Name">Semester Name</th>
       		...
       		foreach ($this->sem as $ad) {
       			...
       			{
       				echo "<td><a href='".base_url()."updatesemester/$ad->id' class='btn btn-primary'>Update</a><a href='".base_url()."deletesemester/$ad->id'' class='btn btn-danger'>Delete </a></td>";
       			}
       			else
       			{
